...
def MyProject():
	...
	l1 = Label(window, text="The predicted Digit is " + str(pred[0]), font=('Calibri', 20))
...
# Label
L1 = Label(window, text="Handwritten Digit Recoginition", font=('Calibri', 25), fg="black")
L1.place(x=95, y=10)

# Button to clear canvas
b1 = Button(window, text="Clear Canvas", font=('Calibri', 15), bg="yellow", fg="black", command=clear_widget)
b1.place(x=150, y=380)

# Button to predict digit drawn on canvas
b2 = Button(window, text="Prediction", font=('Calibri', 15), bg="green", fg="white", command=MyProject)
